  ...
  return (
    <div className="w-full relative">
      ...
      >
        ...
        <div
          className="sticky top-[68%] vp2:top-[65%] vp3:top-[35%] parallax1 z-[2] max-w-[1400px] px-[2rem]
        ...
        >
          ...
          <div className="flex flex-col vp4:flex-row gap-2 justify-center w-full vp3:justify-start mt-[1.5rem]">
            ...
            />
            <button
              className="accent2-bg text-white rounded-full paragraph1 px-4 py-2 vp4:px-6 vp4:py-2
        ...
        {/* Hero cards */}
        <div
          className="opacity-0 HeroCard1 absolute top-[21%] vp3:top-[35%] vp5:top-[35%] right-[50%] vp3:right-[25%] vp5:right-[20%]
        ...
        <div
          className="opacity-0 HeroCard2 absolute top-[21%] vp3:top-[35%] vp5:top-[35%] right-[52%] vp3:right-[25%] vp5:right-[20%]
            parallax2 z-[1] transition-all ease-linear duration-500
        ...
        {/* box container */}
        <div
          className="w-full zoomContainer sticky flex items-center 
            justify-center top-[95vh] vp4:top-[90vh]"
        >
          <div
            className="zoomBox h-[20vw] w-[40vw] rounded-[20px]"
            id="hero_bg"
            style={{
        ...
        <div
          className="bottom-[40vw] vp2:bottom-[-5rem] vp3:bottom-[-10vw] vp4:bottom-[-10vw] vp5:bottom-[-4vw] 
            vp6:bottom-[-9vw] absolute flex-c-c w-full"
        >
          <div
            className="pb-[0rem] vp4:px-[4rem] parallaxPara
