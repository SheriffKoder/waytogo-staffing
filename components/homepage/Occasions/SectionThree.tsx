...
const SectionThree = () => {
  ...
  return (
    ...
    <h2 className="px-[2rem] pb-[min(calc(32rem-2vw),28rem)] sticky z-[-1] bg-black text-white top-[6rem] vp4:px-[4rem] flex flex-row gap-4 heading1 items-center max-w-[2000px] mx-auto mb-[3rem]
